...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post user_infos_url, params: { user_info: { address: @user_info.address, email: @user_info.email, name: @user_info.name, phone: @user_info.phone } }, as: :json
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { address: @user_info.address, email: @user_info.email, name: @user_info.name, phone: @user_info.phone } }, as: :json
    assert_response 200
  end
